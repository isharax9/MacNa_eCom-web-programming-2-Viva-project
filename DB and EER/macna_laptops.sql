...
-- Dumping data for table macna_laptops.orders: ~5 rows (approximately)
DELETE FROM `orders`;
...
-- Dumping data for table macna_laptops.order_item: ~11 rows (approximately)
...
-- Dumping data for table macna_laptops.order_status: ~5 rows (approximately)
...
-- Dumping data for table macna_laptops.product: ~12 rows (approximately)
DELETE FROM `product`;
